/** @format */
// this ready function will make my code work if the document is been loaded
...
function ready() {
  // connect the times icon
  var removeCartIcons = document.getElementsByClassName("btn-remove");
  // loop through the removecartbutton
  ...
  var quantityInput = document.getElementsByClassName("js-form-control");
  for (var i = 0; i < quantityInput.length; i++) {
    var input = quantityInput[i];
    input.addEventListener("change", quantityChanged);
  }

  var addCartItemButton = document.getElementsByClassName("btn-cart");
  for (var i = 0; i < addCartItemButton.length; i++) {
    var button = addCartItemButton[i];
    button.addEventListener("click", addToCartChanged);
  }
  document
...
function purchaseClicked() {
  // alert the user that about purchase
  alert("Thank you for your purchase");
  var cartItems = document.getElementsByClassName("allCartItems")[0];
...
function addToCartChanged(event) {
...
function addItemToCart(title, price, imgSrc) {
  ...
  localStorage.setItem('cartItems', cartRow)
  var cartRowContents = `
  ...
  <!-- the price section -->
  <td class="price-col cartPrice">${price}</td>

  <!-- the quantity section -->
  <td class="quantity-col">
      <div class="cart-product-quantity">
          <input type="number" class="js-form-control" value="1" min="1"
  ...
  cartRow
    ...
    .addEventListener("click", removecartbutton);
  cartRow
    .getElementsByClassName("js-form-control")[0]
    .addEventListener("change", quantityChanged);
}


function updateCartTotal() {
  var cartItemContainer = document.getElementsByClassName("allCartItems")[0];
  var cartRow = cartItemContainer.getElementsByClassName("cartItem");
  var total = 0;
  for (var i = 0; i < cartRow.length; i++) {
    var cartItems = cartRow[i];
    // price element
    var priceElement = cartItems.getElementsByClassName("price-col")[0];
    var price = priceElement.innerText.replace("$", "");
    // quantity element
    var quantityElement =
      cartItems.getElementsByClassName("js-form-control")[0];
    var quantity = quantityElement.value;
    total = total + price * quantity;
  }
  total = Math.round(total * 100) / 100;
  var totalText = document.getElementsByClassName("total")[0];
  totalText.innerText = "$" + total;
  var subTotalText = document.getElementsByClassName("sub-total")[0];
...
let mainPopUp = document.getElementById("new-pop");
let ageWarning = document.getElementById("ageWarning");
let ageAccess = document.getElementById("ageAccess");

let monthInput = document.getElementById("monthInput");
let dayInput = document.getElementById("dayInput");
let yearInput = document.getElementsByClassName("yearinput")[0];
let verificationBtn = document.getElementById("ageVerifyBtn");
...
const popup = document.getElementById("new-pop");
